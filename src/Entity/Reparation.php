...
class Reparation
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\MediaObject", mappedBy="reparation")
     */
    private $gallery;
    ...
    public function removeGallery(MediaObject $gallery): self
    {
        if ($this->gallery->contains($gallery)) {
            ...
            if ($gallery->getReparation() === $this) {
                $gallery->setReparation(null);
            }
        }
